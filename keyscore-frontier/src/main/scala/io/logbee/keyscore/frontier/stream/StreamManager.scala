...
object StreamManager {
  ...
  case class TranslateAndCreateNewStream(streamId: UUID, streamModel: PipelineConfiguration)

  case class ChangeStream(streamId: UUID, stream: PipelineConfiguration)
