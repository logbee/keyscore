...
<<descriptors-influence-ui>> illustrates how a block-developer influences the UI by using the Descriptor API to describe
his/her block.

.How the Descriptor API influence the user interface.
[#descriptors-influence-ui]
image::resources/images/descriptor-01.svg[Data Preview]
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=BooleanParameterDescriptor]
----
...
==== When NOT to use ====
- If the user should enter a password. Prefer <<Password Parameter>>.
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=TextParameterDescriptor]
----

=== Password Parameter ===

==== When to use ====
- If a user should be able enter a secret.
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=PasswordParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=ExpressionParameterDescriptor]
----

[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=ExpressionType]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=NumberParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=DecimalParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldNameParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldNamePatternParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=TextListParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldNameListParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldListParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=ChoiceParameterDescriptor]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=Choice]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=ParameterGroupDescriptor]
----

[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=ParameterGroupCondition]
----

[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=BooleanParameterCondition]
----
...
[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldDirectiveSequenceParameterDescriptor]
----

[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=DirectiveRef]
----

[source]
----
include::{descriptors_base}/parameter-descriptor.proto[tags=FieldDirectiveDescriptor]
----
...
It is recommended to replace german unmlauts with the following unicodes:
[cols=8*]
|===
| Umlaut
| Ä
...
Examples: ermöglichen -> erm**\u00f6**glichen, hinzufügen -> hinzugef**\u00fc**gt.
====
