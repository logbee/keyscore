...
which get displayed within the UI. Therefore the block-developer has to provide the translations. The descriptor API of
KEYSCORE offers special structures to pass localisation information and translations.
...
<<#localization-classdiagram-overview>> illustrates the described concept. This allows, for example the keyscore-manager
