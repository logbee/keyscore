...
/**
 * DroppableBlock is built on top of Draggable and allows dropping draggable elements
 * into dropzone element
 * @class DroppableBlock
 * @module DroppableBlock
 * @extends Draggable
 */
export default class DroppableBlock extends Draggable {
    /**
     * DroppableBlock constructor.
     * @constructs DroppableBlock
     * @param {HTMLElement[]|NodeList|HTMLElement} containers - DroppableBlock containers
     * @param {Object} options - Options for DroppableBlock
     */
    ...
    /**
     * Destroys DroppableBlock instance.
     */
    public destroy() {
        super.destroy();
     ...
     */
    public [dropInDropzone](event, dropzone) {
     ...
     * @param {DragMoveEvent} event - Drag move event
     */
    public [returnToOriginalDropzone](event) {
