...
@Component({
    ...
    template: `
        <div [ngSwitch]="parameterDescriptor.jsonClass" [formGroup]="form">
            ...
            <!--For testing -->
            <!--<mat-form-field *ngSwitchCase="jsonClass.FieldNameListParameterDescriptor"
                            [id]="parameterDescriptor.ref.uuid">
                <input matInput type="text" [placeholder]="parameterDescriptor.defaultValue"
                       [formControlName]="parameterDescriptor.ref.uuid"
                       [id]="parameterDescriptor.ref.uuid" [value]="parameter.value[0]">
                <mat-label>{{parameterDescriptor.info.displayName}}</mat-label>
                <button mat-button *ngIf="value" matSuffix mat-icon-button aria-label="Clear" (click)="value=''">
                    <mat-icon>close</mat-icon>
                </button>
            ...
            <mat-form-field *ngSwitchCase="jsonClass.TextListParameterDescriptor"
                            [id]="parameterDescriptor.ref.uuid">
                <input matInput type="text" [placeholder]="parameterDescriptor.defaultValue"
                       [formControlName]="parameterDescriptor.ref.uuid"
                       [id]="parameterDescriptor.ref.uuid" [value]="parameter.value[0]">
            ...
            <mat-form-field *ngSwitchCase="jsonClass.FieldListParameterDescriptor"
                            [id]="parameterDescriptor.ref.uuid">
                <input matInput type="text" [placeholder]="parameterDescriptor.defaultValue"
                       [formControlName]="parameterDescriptor.ref.uuid"
                       [id]="parameterDescriptor.ref.uuid" [value]="parameter.value[0]">
