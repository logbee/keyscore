            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="accordion">
                            <div *ngFor="let group of (settings$ | async).groups" class="card">
                                <div [attr.id]="'heading-' + group.name" class="card-header btn text-left" data-toggle="collapse" [attr.data-target]="'#collapse-' + group.name">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" (click)="close()">{{'GENERAL.CLOSE' | translate}}</button>
                    </div>
                </div>
            </div>
        </div>
