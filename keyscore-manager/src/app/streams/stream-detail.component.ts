    ...
    template: `
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <textarea id="streamDescription" class="form-control" placeholder="Description" rows="3"
                                  [(ngModel)]="streamDescription"></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mt-3">
                    <div class="card-header">
                        <h5>Current Stream Components</h5>
                    </div>
            ...
            <div class="col-6">
                <div class="card mt-3">
                    ...
                    <div class="card mb-1" *ngFor="let filter of filterComponents; let i = index">
                        <div class="card-title">
                            <div class="row pl-2 pt-2 pr-2">
                                ...
                                <div class="col-2"></div>
                                <div class="col-auto">
                                    <button type="button" class="btn btn-success" (click)="addFilter(filter)">
                                        Add
                                    </button>
                                </div>
                            </div>
