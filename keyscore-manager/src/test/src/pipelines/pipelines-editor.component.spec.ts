...
describe('PipelineEditorComponent', () => {
    ...
    describe('updatePipeline',() => {
        ...
        it('should dispatch an UpdatePipeline action with only the changed configurations on updating configurations',() =>{
            const differenceModel = require('../../resources/difference-pipeline-model-for-config-update-test.json');
            component.storeEditingPipeline = require('../../resources/pipeline-model-for-config-update-test.json');
            const updatedModel = require('../../resources/updated-pipeline-model-for-config-update-test.json');
            const store = TestBed.get(Store);
        ...
        on rearranging and adding pipeline elements `,() =>{
            const differenceModel = require('../../resources/difference-pipeline-model-for-rearrange-update-test.json');
            component.storeEditingPipeline = require('../../resources/pipeline-model-for-rearrange-update-test.json');
            const updatedModel = require('../../resources/updated-pipeline-model-for-rearrange-update-test.json');
            const store = TestBed.get(Store);
